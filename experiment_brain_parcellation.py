...
class ExperimentBrain(Experiment):
    ...
    def run(self):
        ...
        save_records_plot(self.path, [err_validation, err_testing], "err", t.n_train_batches, "upper right")
        save_records_plot(self.path, [dice_validation, dice_testing], "dice", t.n_train_batches, "lower right")
